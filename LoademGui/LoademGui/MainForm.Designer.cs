namespace LoademGui
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.panelExecuteShells = new Panel();
			...
			// panelExecuteShells
			// 
			this.panelExecuteShells.Dock = DockStyle.Fill;
			this.panelExecuteShells.Location = new Point(0, 189);
			this.panelExecuteShells.Name = "panelExecuteShells";
			this.panelExecuteShells.Size = new Size(730, 265);
			this.panelExecuteShells.TabIndex = 2;
			// 
			// inputUrls
			// 
			...
			this.inputClients.ValueChanged += inputClients_ValueChanged;
			// 
			// label2
			// 
			...
			this.Controls.Add(this.panelExecuteShells);
		...
		private Panel panelExecuteShells;
